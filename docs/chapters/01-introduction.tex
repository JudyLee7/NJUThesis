...
突变实验进一步验证了该界面的功能重要性。preS R102A、H105A和W111A突变均可破坏MD与HBV核衣壳的结合，说明这些残基是维持MD--HBc相互作用的关键位点\cite{tao2025structural}。值得注意的是，W111插入的HBc疏水口袋与部分小分子结合位点发生重叠。Makbul等在HBc衣壳样颗粒中观察到Triton X-100（TX100）可结合核心蛋白二聚体界面附近的疏水口袋，ITC测得其与HBc颗粒的结合处于微摩尔量级，并且冷冻电镜密度显示TX100位于由HBc链间残基围成的口袋内，邻近L60、K96、Q99、L100等残基\cite{makbul2021binding}。该研究说明，HBc表面除经典CAM口袋外还存在能够容纳疏水小分子的局部结构，为后续将该口袋与preS-MD竞争结合联系起来提供了结构基础。

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.70\textwidth]{figures/introduction/makbul2021_tx100_hbc_pocket.png}
  \caption{Triton X-100结合HBc二聚体疏水口袋的结构示意。TX100位于HBc链C和链D形成的二聚体界面附近，并与周围疏水残基及K96等残基相邻。图片截取自Makbul等的研究\cite{makbul2021binding}。}
  \label{fig:makbul2021-tx100-pocket}
\end{figure}

香叶醇（geraniol）也被报道能够直接结合HBc核心蛋白。Khayenko等结合ITC和冷冻电镜发现，geraniol以微摩尔亲和力结合HBc中心疏水口袋，冷冻电镜图中可在不对称单位内多个疏水口袋观察到geraniol相关密度；其结合位置涉及P5、L60、K96、E64和V13等残基，并与TX100结合位点发生空间重叠\cite{khayenko2024induction}。因此，TX100和geraniol并不只是非特异性疏水添加剂，而是能够占据HBc特定疏水口袋的小分子。考虑到preS-MD中的W111同样插入该区域附近的HBc口袋，这些结构结果提示，小分子占位可能通过空间竞争或局部构象扰动削弱MD--HBc结合。
...
在上述结构基础上，本实验室投稿中的研究进一步检测了TX100和geraniol是否会影响preS-MD与HBV核衣壳的体外结合。在Strep-tag pull-down实验中，研究者先将HBV核心蛋白与TX100或geraniol预孵育，再加入带Strep标签的三聚化MD构建体；结果显示，在preS和输入核心蛋白信号仍可检测的条件下，小分子处理组pull-down中的anti-core信号明显降低\cite{tao2025structural}。这一结果支持TX100和geraniol在该体外体系中能够削弱preS-MD对HBc的结合，但由于该工作仍处于投稿阶段，本文将其作为尚待正式发表和进一步独立验证的机制性证据来表述。

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.68\textwidth]{figures/introduction/tao2025_fig4d_pulldown_small_molecules.png}
  \caption{TX100和geraniol抑制MD--HBc体外结合的pull-down证据。Strep-tag pull-down显示，核心蛋白经TX100或geraniol预孵育后，随MD被拉下的anti-core信号降低，而输入样品中的核心蛋白和preS信号仍可检测。该图来自本实验室投稿中的研究，尚未正式发表\cite{tao2025structural}。}
  \label{fig:tao2025-small-molecule-pulldown}
\end{figure}
