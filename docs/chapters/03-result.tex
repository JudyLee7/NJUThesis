...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\textwidth]{docs/figures/result/result_13_nanobit_one_to_one.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1.0\textwidth]{docs/figures/result/result_14_repurified-hbvcp182-nanobit-titration.png}
  \caption{固定HBVCp182-SmBiT浓度为12.5 nM并滴定含preS 87--114的LgBiT融合蛋白。A，实验组信号随LgBiT-preS浓度升高而增加。B，扣除阴性对照后的特异性信号呈饱和趋势，Langmuir单一位点特异性吸附拟合后的Kd为39.86。}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1.0\textwidth]{docs/figures/result/result_15_foldon-inhibitor-initial.png}
...
根据拟合结果，在该含foldon体系条件下，Triton X-100的表观IC$_{50}$为618.2 $\mu$M，NP-40的表观IC$_{50}$为180.5 $\mu$M，香叶醇的表观IC$_{50}$为1780 $\mu$M。这些数值说明三种候选分子均可在该体系中引起不同程度的信号下降，但仍应被理解为当前检测构型下的表观抑制结果，而非单价HBc--preS结合状态下的精确IC$_{50}$。

\begin{figure}[htbp]
  \centering
  \includegraphics[width=1.0\textwidth]{docs/figures/result/result_16_foldon-inhibitor-preincubation.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{docs/figures/result/result_17_constructs_ljq_67.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{docs/figures/result/result_18_ljq_67.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{docs/figures/result/result_19_foldon-free-nanobit-titration.png}
...
结果显示，wild-type preS 87--114在各浓度下均产生最高发光信号，并随LgBiT融合蛋白浓度升高呈现逐渐趋于饱和的曲线。GST-LgBiT阴性对照也随浓度升高出现一定背景信号，但整体低于含preS的实验组，说明该体系中仍可区分preS依赖性互作与非特异NanoBiT互补背景。与wild-type相比，R102A、H105A和W111A三个突变体的发光信号均降低，提示这些位点均参与preS 87--114与HBc的结合。

扣除GST-LgBiT背景后，突变体之间的差异更加清楚：W111A仍保留一定残余结合信号，但明显低于wild-type；H105A和R102A下降更为显著，整体更接近背景水平。该结果支持R102、H105和W111共同构成或维持HBc--preS结合界面，其中R102和H105对结合贡献更为关键。由于该实验仍处于GST标签保留状态，后续进一步去除GST标签后再比较突变体，有助于判断上述趋势是否仍能在更接近单体preS片段的条件下保持一致。

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{docs/figures/result/result_20_preS_mutant.png}
  \caption{保留GST标签条件下不同preS突变体与HBc结合能力比较。wild-type preS 87--114产生最高NanoBiT信号，R102A、H105A和W111A均降低HBc--preS互作信号，其中R102A和H105A下降更明显。}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{docs/figures/result/result_21_ppase-gst-cleavage.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{docs/figures/result/result_22_gstfree-pres-mutant-nanobit.png}
...
本章首先建立并比较了HBc--preS体外互作检测体系。三种ELISA构型分别从HBc直接包被、StrepXT捕获preS和抗HBc Fab捕获HBc三个角度优化检测流程。结果显示，HBc直接包被体系受到preS或检测抗体非特异吸附影响；StrepXT捕获preS能够改善preS呈递，但核心蛋白检测窗口和Z-factor仍不足；抗HBc Fab捕获HBc虽改善了核心蛋白固定方式，但未能显著降低preS检测背景。总体来看，常规固相ELISA难以稳定报告HBc--preS弱相互作用，最多适合作为辅助验证手段，而不适合作为本研究后续突变体比较和小分子抑制评价的主要定量平台。
