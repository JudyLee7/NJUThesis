...
\subsection{NanoBiT相关融合蛋白的构建与制备}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{docs/figures/result/result_10_ljq_1.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{docs/figures/result/result_11_ljq_234.png}
